...
public class Plan extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6242155684756309544L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Plan\",\"namespace\":\"events\",\"fields\":[{\"name\":\"planId\",\"type\":\"long\"}]}");
   ...
   */
  public Plan(java.lang.Long planId) {
    this.planId = planId;
  }
  ...
  /**
   * Gets the value of the 'planId' field as an Optional<java.lang.Long>.
   * @return The value wrapped in an Optional&lt;java.lang.Long&gt;.
   */
  public Optional<java.lang.Long> getPlanId() {
    return Optional.<java.lang.Long>ofNullable(planId);
  }
   ...
   * @return The value wrapped in an Optional&lt;java.lang.Long&gt;.
   */
  public Optional<java.lang.Long> getOptionalPlanId() {
    return Optional.<java.lang.Long>ofNullable(planId);
  }
   ...
   */
  public static events.Plan.Builder newBuilder() {
    return new events.Plan.Builder();
  }
   ...
   * @return A new Plan RecordBuilder
   */
  public static events.Plan.Builder newBuilder(events.Plan.Builder other) {
    if (other == null) {
      return new events.Plan.Builder();
    } else {
      return new events.Plan.Builder(other);
    }
  }
   ...
   * @return A new Plan RecordBuilder
   */
  public static events.Plan.Builder newBuilder(events.Plan other) {
    if (other == null) {
      return new events.Plan.Builder();
    } else {
      return new events.Plan.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Plan>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(events.Plan.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(events.Plan other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.planId)) {
        this.planId = data().deepCopy(fields()[0].schema(), other.planId);
    ...
    /**
      ...
      * @return This builder.
      */
    public events.Plan.Builder setPlanId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public events.Plan.Builder clearPlanId() {
